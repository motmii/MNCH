 ...
 *     precaches the 6 deleted legacy SVGs, and pins CACHE_VERSION >= v1.22.0
...
check("cache version is bumped to >= v1.22.0 (UI/UX refresh revision)", !!verMatch && (+verMatch[1] > 1 || (+verMatch[1] === 1 && +verMatch[2] >= 22)));
