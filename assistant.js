...
(function () {
  ...
  function localAnswer(raw) {
    ...
    if (has("اداة", "أداة", "ادوات", "أدوات", "tool")) {
      ...
      if (has("base64", "hex", "url")) return "أداة **المشفّرات** متاحة في قسم الأدوات (#tools): تحوّل النص بين Base64 وHex وURL في الاتجاهين (ترميز وفك)، وكل شيء يجري داخل متصفحك.";
